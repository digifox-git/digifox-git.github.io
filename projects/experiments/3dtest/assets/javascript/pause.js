...
let pod_move = new Audio('../../assets/audio/pod_cursor_move.wav')
pod_move.volume = 0.5
let pod_select = new Audio('../../assets/audio/pod_select.wav')
pod_select.volume = 0.5
let pod_error = new Audio('../../assets/audio/pod_error_01.wav')
